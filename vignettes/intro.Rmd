...
- see `opc` data documentation for details
...
Here's a simple example of how to process the raw OPC data in `OPC027.D00` and store the output in opc tibble called `df`. Note that this requires the user to interactively select the downcast so does not actually run in this vignette.
